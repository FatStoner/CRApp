...
-   **🔄 Import/Export**: Full support for TavernAI V2 cards (PNG) and JSON. Quick clipboard importing from **SpicyChat**, **JanitorAI**, **AfterHour.app**, **GirlfriendGPT**, and **CraveU**.
